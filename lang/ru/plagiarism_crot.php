...
$string['crot'] = 'Крот';
$string['crotexplain'] = 'Крот - модуль проверки на плагиат: он проводит сравнение как файлов, скопированных у студентов этого же учебного заведения, <strike>так и файлов, скопированных из интернета</strike>. Он использует технологию "отпечатка" документа для сравнения документов<strike> и поисковую систему MSN Live для осуществления поиска в интернете</strike>.<br/><br/><strike>Более подробную информацию смотрите на <a href="http://www.crotsoftware.com">www.crotsoftware.com</a></strike><p>Оригинальный репозиторий мертв</p>';
...
$string['val_similarity_score'] = 'Процент совпадения: {$a} %';
...
$string['updatereportscores']='Обновить отчет антиплагиата';